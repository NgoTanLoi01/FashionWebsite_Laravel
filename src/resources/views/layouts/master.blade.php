...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('UserLTE/assets/vendor/line-awesome/line-awesome/line-awesome/css/line-awesome.min.css')}}">
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('UserLTE/assets/js/main.js') }}"></script>
    <script src="{{ asset('UserLTE/assets/js/demos/demo-6.js') }}"></script>
    @yield('js')
</body>
